...
/**
  ...
  *
  * @checksum - 6e2934b7b58db6473288cb13bc2ad3071df199d31e37fceafd6a4f532f67f1ca
  * @variables - radius=rounded,accentColor=pink,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "button__input": {
    ...
    "text-pink-600": true,
    "hover:bg-pink-50": true,
    "dark:border-pink-500": true,
    "dark:text-pink-500": true,
    "dark:hover:bg-pink-900/20": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
