...
/**
  ...
  *
  * @checksum - 9d0d696a40750262041b32716c1323e2a22930afb65bd71b3e09b62ceb078d21
  * @variables - radius=rounded-none,accentColor=amber,colorTemperature=neutral,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[17em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:aria-selected:before:ring-amber-500": true,
    "data-[is-active]:aria-selected:before:ring-inset": true,
    "data-[is-active]:aria-selected:before:ring-offset-amber-100": true
  },
  ...
  "button__input": {
    ...
    "dark:hover:bg-amber-900/20": true
  },
  "checkbox__decorator": {
    "rounded-none": true
  },
